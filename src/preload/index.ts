...
const api: RendererApi = {
  ...
  fetchRemote: (repoPath, remote) => invoke('repo:fetch-remote', repoPath, remote),
  addRemote: (repoPath, input) => invoke('repo:add-remote', repoPath, input),
  updateRemote: (repoPath, input) => invoke('repo:update-remote', repoPath, input),
  ...
  getGitHubWorkflowRunDetail: (input) =>
    invoke('github:workflow-run-detail', input),
